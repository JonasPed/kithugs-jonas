...
public class ServiceStarter {
    ...
    private static final Logger serviceLogger = LoggerFactory.getLogger("kithugs-jonas");
    ...
    public GenericContainer startServicesInDocker() {
        ...
        var resourcesContainerName = "kithugs-jonas-resources";
        ...
        if (resourcesRunning) {
            ...
            service = new GenericContainer<>("local/kithugs-jonas-qa:dev")
        ...
        service.withNetwork(dockerNetwork)
                .withNetworkAliases("kithugs-jonas")
